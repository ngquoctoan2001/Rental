...
export default function SettingsPage() {
  ...
  const [billing, setBilling] = useState({ autoGenerateDay: 25, paymentDueDays: 5, remindBeforeDays: 1, autoSendNotification: true });
  ...
  useEffect(() => {
    ...
    if (settings.billing) setBilling({ autoGenerateDay: settings.billing.autoGenerateDay ?? 25, paymentDueDays: settings.billing.paymentDueDays ?? 5, remindBeforeDays: settings.billing.remindBeforeDays ?? 1, autoSendNotification: settings.billing.autoSendNotification ?? true });
  }, [settings]);
                   ...
                   <div className="space-y-8">
                      ...
                      <div className="flex items-center justify-between group">
                        ...
                        <div className="flex items-center gap-3">
                           ...
                           <input type="number" min={1} max={14} value={billing.remindBeforeDays} onChange={e => setBilling(b => ({ ...b, remindBeforeDays: Number(e.target.value) }))} className="w-16 px-3 py-2 bg-slate-50 border border-slate-100 rounded-xl text-center font-black text-indigo-600" />
                           <span className="text-xs font-black text-slate-400">ngày</span>
                        </div>
                      </div>
                   </div>
