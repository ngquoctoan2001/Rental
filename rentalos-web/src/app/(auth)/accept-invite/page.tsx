...
import { AlertCircle, CheckCircle2, Lock, Phone, ShieldCheck, User } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md w-full bg-white p-10 rounded-[2.5rem] shadow-xl text-center">
          ...
          <h2 className="text-2xl font-black text-slate-900 mb-4">Thiếu mã lời mời</h2>
          <p className="text-slate-500 font-medium mb-8">
            Liên kết này không chứa token hợp lệ. Vui lòng mở lại link từ email mời của quản trị viên.
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
        <div className="max-w-md w-full bg-white p-10 rounded-[2.5rem] shadow-xl text-center">
          ...
          <h2 className="text-2xl font-black text-slate-900 mb-4">Kích hoạt tài khoản thành công</h2>
          <p className="text-slate-500 font-medium mb-8">
            Tài khoản nhân viên đã được thiết lập. Bạn có thể đăng nhập ngay bằng mật khẩu vừa tạo.
          </p>
          <button
        ...
        <div className="max-w-md w-full animate-slide-up">
          <div className="mb-10 text-center">
            ...
            <p className="text-slate-500 mt-2 font-medium">
              {tenantSlug ? <>Bạn đang tham gia tenant <strong>{tenantSlug}</strong>.</> : 'Thiết lập thông tin để kích hoạt tài khoản nhân viên.'}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 px-6 bg-slate-900 text-white rounded-2xl font-bold text-lg hover:bg-slate-800 transition-all mt-4 disabled:opacity-60"
            >
              {loading ? 'Đang thiết lập tài khoản...' : 'Kích hoạt tài khoản'}
            </button>
          </form>
        </div>
      </div>
        ...
        <div className="relative z-10 h-full flex flex-col justify-center text-white">
          ...
          <div className="space-y-8">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2">Kích hoạt nhanh</h4>
                <p className="text-indigo-100 font-medium">Thiết lập hồ sơ và mật khẩu trong một bước.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2">Đúng tenant</h4>
                <p className="text-indigo-100 font-medium">Sau khi hoàn tất, bạn đăng nhập lại vào đúng tenant đã được mời.</p>
              </div>
            </div>
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h4 className="text-xl font-bold mb-2">Đi đúng API backend</h4>
                <p className="text-indigo-100 font-medium">Form này gọi trực tiếp endpoint kích hoạt nhân viên bằng token mời.</p>
              </div>
            </div>
          </div>
        </div>
