...
export const roomsApi = {
  ...
  update: (id: string, data: any) => api.put(`/rooms/${id}`, { ...data, id }),
  changeStatus: (id: string, data: { id: string; newStatus: string; maintenanceNote?: string; estimatedDoneDate?: string | null }) => api.patch(`/rooms/${id}/status`, data),
